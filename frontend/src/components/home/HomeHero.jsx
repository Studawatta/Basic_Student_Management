  ...
  return (
    <div className="heroContW">
      <div className="heroCont">
        ...
        <div className="title">
          <p>
            Improve the way your school manages information and automates
            processes.
          </p>
        </div>
        ...
        <div className="BeniCont">
          <div className="Beni">
            ...
            <div className="BeniPara">
              <p className="para">
                Comprehensive, cutomizable student dashboard provides
                at-a-glance access and editing capabilities for numerous areas,
                including: academics, alerts, behavior, contact info,
                demographics, finance, schedules, and transcripts.
              </p>
            </div>
          </div>
          <div className="Beni">
